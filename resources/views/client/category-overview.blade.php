...
<div class="container">
    <nav class="breadcrumb">
      ...
      <span class="breadcrumb-item active">{{$categories->title}}</span>
    </nav>
          ...
          <div class="col-lg-12">
            ...
            >
              ...
              <tbody>
                ...
                @if (count($categories->forum) > 0)

                @foreach ($categories->forum as $forum)
                <tr>
                  <td>
                    <h3 class="h5">
                  ...
                  <td><div>{{$forum->discussion->count()}}</div></td>
